...
def main():
    ...
    parser.add_argument("--language", default="bilingual", help="Brief language: zh/en/bilingual, or 中文/英文/双语. Default: bilingual.")
    parser.add_argument("--detail", default="detailed", help="Brief detail level: minimal/normal/detailed, or 极简/普通/详细. Default: detailed.")
